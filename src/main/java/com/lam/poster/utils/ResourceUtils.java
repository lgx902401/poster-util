...
import com.lam.poster.exception.BusinessException;
...
//    }
     ...
     * @throws IOException
     */
    public static String getResourcePath(String resourceName) throws BusinessException {
...
//        throw new IOException(resourceName + " resource not found!");
        throw new BusinessException(ErrorCode.BasicCode.BAD_REQUEST,resourceName + " resource not found!");
